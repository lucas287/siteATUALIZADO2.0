...
<head>
    ...
    <style>
        ...
        #contact-content {
            ...
            align-items: center;
            height: 800px; /* Ocupa toda a altura da tela */
        }
        ...
        /* Estilo de navegação centralizada */
        nav ul {
            list-style: none;
            padding: 0;
            margin: 0;
        ...
        @media (max-width: 768px) {
            ...
            form {
                max-width: 100%; /* Faz o formulário ocupar mais espaço em telas pequenas */
                margin: 20px auto;
            }
...
<header>
    <nav>
        <ul>
            ...
            <li><a href="index.html"><i class="fas fa-home"></i></a></li> <!-- Ícone de casa -->
        </ul>
    </nav>
</header>

<section id="contact-content">
    <h1>Preencha para analisar sua compra.</h1>
    ...
    <form action="https://api.staticforms.xyz/submit" method="post">
        ...
        <input type="text" name="veiculo" placeholder="Nome do veículo ou da moto" required>
        <input type="text" name="cpf" placeholder="Coloque seu CPF" required>
        <input type="text" name="rg" placeholder="Coloque seu RG" required>
        <input type="text" name="endereco" placeholder="Coloque seu Endereço (ex:Rua voinich, 210, Osvaldo Cruz, SP)" required>
        <textarea name="message" placeholder="Mensagem" required></textarea>
        <input type="hidden" name="replyTo" value="@">
        <input type="hidden" name="redirectTo" value="https://analisedacompra.netlify.app/">
