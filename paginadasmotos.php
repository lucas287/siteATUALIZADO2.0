...
<center><h1>Encontre sua moto <span>PERFEITA</span></h1></center>
    <div class="container">
        <div class="listings">
            <?php
            ...
            $query_usuarios = "SELECT id, nome, km, ano, foto, preco, tipo FROM veiculo WHERE tipo='moto' ORDER BY id DESC";
