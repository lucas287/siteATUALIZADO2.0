...
<?php
  ...
  <form method="POST" action="editarCli.php" onsubmit="return validarFormulario();">
    <input type="hidden" name="id" value="<?php echo $row_usuario['id']; ?>">
      ...
      <label>CPF: </label>
      <input type="text" name="cpf" placeholder="Digite o seu CPF" value="<?php echo $row_usuario['cpf']; ?>">

      <label>CNH: </label>
      <input type="text" name="cnh" placeholder="Digite sua CNH" value="<?php echo $row_usuario['cnh']; ?>">

      <label>RG: </label>
      <input type="text" name="rg" placeholder="Digite o seu RG" value="<?php echo $row_usuario['rg']; ?>">

      <label>Telefone: </label>
      <input type="text" name="telefone" placeholder="Digite o seu Telefone" value="<?php echo $row_usuario['telefone']; ?>">
      <label>Endereço: </label>
      <input type="text" name="endereco" placeholder="Digite sua Cidade" value="<?php echo $row_usuario['endereco']; ?>">
 <center>
  <label>Estado: </label>
  <select name="estado">
